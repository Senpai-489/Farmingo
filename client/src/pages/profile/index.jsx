...
const Profile = () => {
  ...
  return (
    <div className="mx-auto mt-20 mb-10 p-4 shadow-2xl border-white rounded-3xl xl:w-[50vw] l:w-[50vw] md:w-[60vw] flex flex-col items-center justify-center overflow-auto hide-scrollbar">
      ...
      <form className="space-y-4 h-[110vh] flex flex-col items-center justify-center ">
      <h2 className="text-3xl font-bold mb-6 my-2">Farmer Profile</h2>
        ...
        <div>
          <label className="block text-gray-700 text-m font-bold mb-2" htmlFor="areaOfLand">
        ...
        <div>
          ...
          <MapContainer center={[51.505, -0.09]} zoom={13} style={{ height: '20rem', width: '40rem' }}>
            <TileLayer
          ...
          <p className="text-gray-600 text-m mt-2">
            {location ? `Selected Coordinates: Latitude: ${location[0]}, Longitude: ${location[1]}` : 'Click on the map to select your location.'}
          </p>
        </div>
        ...
        <div>
          <button
            type="submit"
            className="w-[20rem] bg-blue-500 text-white font-bold text-lg py-2 px-4 rounded-lg hover:bg-blue-700" onClick={saveChanges}
          >
            Submit
          </button>
        </div>
